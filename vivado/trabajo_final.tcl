...
#
# Generated by Vivado on Wed Jun 17 16:22:48 -03 2020
...
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/bd/trabajo_final_top/hdl/trabajo_final_top_wrapper.vhd"
...
set files [list \
 ...
 [file normalize "${origin_dir}/../bd/trabajo_final_top/hdl/trabajo_final_top_wrapper.vhd"] \
]
...
set file "$origin_dir/../bd/trabajo_final_top/hdl/trabajo_final_top_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "trabajo_final_top_wrapper" -objects $obj
...
# Proc to create BD trabajo_final_top
proc cr_bd_trabajo_final_top { parentCell } {
...
# End of cr_bd_trabajo_final_top()
cr_bd_trabajo_final_top ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files trabajo_final_top.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files trabajo_final_top.bd ] 
set_property IS_ENABLED "1" [get_files trabajo_final_top.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files trabajo_final_top.bd ] 
set_property IS_LOCKED "0" [get_files trabajo_final_top.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files trabajo_final_top.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files trabajo_final_top.bd ] 
set_property PFM_NAME "" [get_files trabajo_final_top.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files trabajo_final_top.bd ] 
set_property SYNTH_CHECKPOINT_MODE "None" [get_files trabajo_final_top.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files trabajo_final_top.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files trabajo_final_top.bd ] 
set_property USED_IN_SIMULATION "1" [get_files trabajo_final_top.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files trabajo_final_top.bd ] 
