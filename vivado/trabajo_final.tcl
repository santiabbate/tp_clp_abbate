...
#
# trabajo_final.tcl: Tcl script for re-creating project 'trabajo_final'
#
# Generated by Vivado on Wed Jun 17 15:48:02 -03 2020
...
#
# 1. This project restoration tcl script (trabajo_final.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/vivado/trabajo_final.srcs/sources_1/bd/trabajo_final/hdl/trabajo_final_wrapper.vhd"
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/vivado/dds_modulator_tb_behav.wcfg"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/hdl/dds_modulator_pkg.vhd"
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/hdl/dds_modulator.vhd"
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/hdl/config_regs.vhd"
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/xdc/trabajo_final_ArtyZ7.xdc"
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/tb/dds_compiler_dds_compiler_0_0.vhd"
#    "/mnt/Archivos/cese/5CLP/trabajo_practico/tb/dds_modulator_tb.vhd"
#
#*****************************************************************************************
...
set _xil_proj_name_ "trabajo_final"
...
set script_file "trabajo_final.tcl"
...
set files [list \
 [file normalize "${origin_dir}/../hdl/dds_modulator_pkg.vhd"] \
 [file normalize "${origin_dir}/../hdl/dds_modulator.vhd"] \
 [file normalize "${origin_dir}/../hdl/config_regs.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/trabajo_final.srcs/sources_1/bd/trabajo_final/hdl/trabajo_final_wrapper.vhd" ]\
]
set imported_files [import_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../hdl/dds_modulator_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "dds_modulator" -objects $file_obj
set_property -name "path_mode" -value "RelativeFirst" -objects $file_obj
set_property -name "used_in" -value "synthesis simulation" -objects $file_obj
set_property -name "used_in_simulation" -value "1" -objects $file_obj
set_property -name "used_in_synthesis" -value "1" -objects $file_obj

set file "$origin_dir/../hdl/dds_modulator.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../hdl/config_regs.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "hdl/trabajo_final_wrapper.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "trabajo_final_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../xdc/trabajo_final_ArtyZ7.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../xdc/trabajo_final_ArtyZ7.xdc"
set file [file normalize $file]
...
set files [list \
 [file normalize "${origin_dir}/../tb/dds_compiler_dds_compiler_0_0.vhd"] \
 [file normalize "${origin_dir}/../tb/dds_modulator_tb.vhd"] \
]
add_files -norecurse -fileset $obj $files
...
set file "$origin_dir/../tb/dds_modulator_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "xsim.simulate.runtime" -value "2200us" -objects $obj
...
if { [get_files dds_modulator_pkg.vhd] == "" } {
  import_files -quiet -fileset sources_1 /mnt/Archivos/cese/5CLP/trabajo_practico/hdl/dds_modulator_pkg.vhd
}
if { [get_files dds_modulator.vhd] == "" } {
  import_files -quiet -fileset sources_1 /mnt/Archivos/cese/5CLP/trabajo_practico/hdl/dds_modulator.vhd
}
if { [get_files config_regs.vhd] == "" } {
  import_files -quiet -fileset sources_1 /mnt/Archivos/cese/5CLP/trabajo_practico/hdl/config_regs.vhd
}


# Proc to create BD trabajo_final
proc cr_bd_trabajo_final { parentCell } {
...
# config_regs, dds_modulator
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.98537",
   "Default View_TopLeft":"-118,-104",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port resetn_i -pg 1 -lvl 0 -x 0 -y 100 -defaultsOSRD
preplace port clk_i -pg 1 -lvl 0 -x 0 -y 60 -defaultsOSRD
preplace portBus btn_i -pg 1 -lvl 0 -x 0 -y 210 -defaultsOSRD
preplace inst ila_0 -pg 1 -lvl 3 -x 920 -y 90 -defaultsOSRD
preplace inst xlconstant_6 -pg 1 -lvl 3 -x 920 -y 270 -defaultsOSRD
preplace inst dds_modulator_0 -pg 1 -lvl 2 -x 560 -y 190 -defaultsOSRD
preplace inst config_regs_0 -pg 1 -lvl 1 -x 170 -y 210 -defaultsOSRD
preplace netloc dds_modulator_0_m_axis_modulation_tdata 1 2 1 780 70n
preplace netloc dds_modulator_0_m_axis_modulation_tvalid 1 2 1 800 90n
preplace netloc dds_modulator_0_dds_en_o 1 2 1 810 110n
preplace netloc resetn_i_0_1 1 0 3 NJ 100 330J 60 790
preplace netloc clk_i_1 1 0 3 NJ 60 320 50 NJ
preplace netloc xlconstant_6_dout 1 2 2 NJ 210 1020
preplace netloc config_regs_0_config_reg_0 1 1 1 N 160
preplace netloc config_regs_0_config_reg_1 1 1 1 N 180
preplace netloc config_regs_0_config_reg_2 1 1 1 N 200
preplace netloc config_regs_0_config_reg_3 1 1 1 N 220
preplace netloc config_regs_0_config_reg_4 1 1 1 N 240
preplace netloc config_regs_0_config_reg_5 1 1 1 N 260
preplace netloc btn_i_1 1 0 1 NJ 210
levelinfo -pg 1 0 170 560 920 1040
pagesize -pg 1 -db -bbox -sgen -120 -10 1040 330
"
}
...
# End of cr_bd_trabajo_final()
cr_bd_trabajo_final ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files trabajo_final.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files trabajo_final.bd ] 
set_property IS_ENABLED "1" [get_files trabajo_final.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files trabajo_final.bd ] 
set_property IS_LOCKED "0" [get_files trabajo_final.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files trabajo_final.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files trabajo_final.bd ] 
set_property PFM_NAME "" [get_files trabajo_final.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files trabajo_final.bd ] 
set_property SYNTH_CHECKPOINT_MODE "None" [get_files trabajo_final.bd ] 
set_property USED_IN "synthesis implementation" [get_files trabajo_final.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files trabajo_final.bd ] 
set_property USED_IN_SIMULATION "0" [get_files trabajo_final.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files trabajo_final.bd ] 
